...
[field2] view:  <input name="view" type="text" size="16" value="index" /><br />
<h4>Form Files</h4>
[file0]<em> file0</em>:  <input name="file0" type="file" size="16"" style="font-family: Courier, monospace"/><br />
